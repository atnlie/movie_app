...
const Details: React.FC<{movie: IMovie, onPress: () => void, addToList: () => void }> = ({movie, onPress, addToList}) => {
    return (


        <div className="bg-white w-full h-full rounded-lg rounded-2xl">
                ...
                <div className="rounded-2xl text-blue-600">
                    <div className="flex p-2 gap-2 mb-5">
                        ...
                        <div className="pl-5 pr-5">
                            ...
                            <p>More info: <span className="font-bold">{movie?.primaryImage?.caption?.plainText}</span></p>
