    ...
    return (
        <main className="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
            <div className="text-center">
                ...
                <p className="mt-6 text-base leading-7 text-white-600">Sorry, we couldn’t find the page you’re looking
                    for.</p>
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    ...
                    <Link to="https://www.linkedin.com/in/henikurniyanto/" target="_blank" className="text-sm font-semibold text-white-900">Contact support <span
